...
System.namespace("Slipe.Shared.Elements", function (namespace)
  ...
  namespace.class("PhysicalElement", function (namespace)
    ...
    setOffset, GetWithinRange, class, __ctor__
    ...
    getCollisionShape = function (this)
      return System.cast(SlipeSharedCollisionShapes.CollisionShape, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetElementColShape(this.element)))
    end
    ...
    getLowLODElement = function (this)
      return System.cast(class, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetLowLODElement(this.element)))
    end
    ...
    getToAttached = function (this)
      return System.cast(class, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetElementAttachedTo(this.element)))
    end
