...
System.namespace("Slipe.Client.Vehicles", function (namespace)
  ...
  namespace.class("Vehicle", function (namespace)
    ...
    getControler = function (this)
      return System.cast(SlipeClientPeds.Player, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetVehicleController(this.element)))
    end
    getOccupants = function (this)
      ...
      for _, entry in System.each(elements) do
        local p = System.cast(SlipeClientPeds.Player, SlipeSharedElements.ElementManager.getInstance():GetElement(entry.Value))
        local s = entry.Key
        dictionary:Add(s, p)
      end
      return dictionary
    ...
    GetOccupant = function (this, seat)
      return System.cast(SlipeClientPeds.Player, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetVehicleOccupant(this.element, seat)))
    end
    -- <summary>
