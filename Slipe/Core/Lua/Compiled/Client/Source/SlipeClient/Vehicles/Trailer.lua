...
System.namespace("Slipe.Client.Vehicles", function (namespace)
  ...
  namespace.class("Trailer", function (namespace)
    ...
    getTowingVehicle = function (this)
      return System.cast(SlipeClientVehicles.Vehicle, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetVehicleTowingVehicle(this.element)))
    end
