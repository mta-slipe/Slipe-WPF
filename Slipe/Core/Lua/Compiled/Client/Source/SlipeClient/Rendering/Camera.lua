...
System.namespace("Slipe.Client", function (namespace)
  ...
  namespace.class("Camera", function (namespace)
    ...
    getTarget = function (this)
      return System.cast(SlipeSharedElements.PhysicalElement, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaClient.GetCameraTarget()))
    end
