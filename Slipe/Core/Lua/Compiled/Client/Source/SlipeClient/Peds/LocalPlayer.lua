...
System.namespace("Slipe.Client.Peds", function (namespace)
  namespace.class("LocalPlayer", function (namespace)
    ...
    getWantedLevel, getIsMapVisible, getMapBoundingBox, DetonateSatchels, GiveMoney, SetHudComponentVisible, IsHudComponentVisible, TakeMoney, 
    PlaySoundFrontEnd, class, __ctor__
