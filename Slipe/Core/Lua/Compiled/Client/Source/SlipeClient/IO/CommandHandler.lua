...
System.namespace("Slipe.Client.IO", function (namespace)
  ...
  namespace.class("CommandHandler", function (namespace)
    ...
    Execute = function (this, args)
      SlipeMtaDefinitions.MtaClient.ExecuteCommandHandler(this.command, System.String.Join(" ", args))
    end
    -- <summary>
    -- Executes the command handler
    -- </summary>
    ...
    Execute1 = function (command, args)
      SlipeMtaDefinitions.MtaClient.ExecuteCommandHandler(command, System.String.Join(" ", args))
    end
    return {
      Execute = Execute,
      Execute1 = Execute1,
