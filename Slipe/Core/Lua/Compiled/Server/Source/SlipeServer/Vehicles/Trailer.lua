...
System.namespace("Slipe.Server.Vehicles", function (namespace)
  ...
  namespace.class("Trailer", function (namespace)
    ...
    getTowingVehicle = function (this)
      return System.cast(SlipeServerVehicles.Vehicle, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetVehicleTowingVehicle(this.element)))
    end
