...
System.namespace("Slipe.Server.Vehicles", function (namespace)
  namespace.class("Vehicle", function (namespace)
    ...
    __ctor1__ = function (this, model, position)
      __ctor2__(this, model, position:__clone__(), SystemNumerics.Vector3.getZero(), "", 1, 1)
    end
    -- <summary>
    ...
    __ctor2__ = function (this, model, position, rotation, numberplate, variant1, variant2)
      __ctor3__(this, SlipeMtaDefinitions.MtaShared.CreateVehicle(model:getID(), position.X, position.Y, position.Z, rotation.X, rotation.Y, rotation.Z, numberplate, false, variant1, variant2))
    end
    __ctor3__ = function (this, element)
      SlipeSharedVehicles.SharedVehicle.__ctor__(this, element)
    end
    getControler = function (this)
      return System.cast(SlipeServerPeds.Player, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetVehicleController(this.element)))
    end
    getOccupants = function (this)
      ...
      for _, entry in System.each(elements) do
        local p = System.cast(SlipeServerPeds.Player, SlipeSharedElements.ElementManager.getInstance():GetElement(entry.Value))
        local s = entry.Key
        dictionary:Add(s, p)
      end
      return dictionary
    ...
    GetOccupant = function (this, seat)
      return System.cast(SlipeServerPeds.Player, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetVehicleOccupant(this.element, seat)))
    end
    -- <summary>
