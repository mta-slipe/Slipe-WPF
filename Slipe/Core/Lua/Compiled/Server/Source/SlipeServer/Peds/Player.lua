  ...
  namespace.class("Player", function (namespace)
    ...
    getTeam = function (this)
      local default, extern = System.try(function ()
        return true, System.cast(SlipeServerGameServer.Team, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaShared.GetPlayerTeam(this.element)))
    ...
    getAccount = function (this)
      return SlipeServerAccounts.AccountManager.getInstance():GetAccount(SlipeMtaDefinitions.MtaServer.GetPlayerAccount(this.element))
    end
    ...
    getRandom = function ()
      local default, extern = System.try(function ()
        return true, System.cast(class, SlipeSharedElements.ElementManager.getInstance():GetElement(SlipeMtaDefinitions.MtaServer.GetRandomPlayer()))
      end, function (default)
        if System.is(default, SlipeMtaDefinitions.MtaException) then
          return true, nil
        else
