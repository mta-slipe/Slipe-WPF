...
return function (out)
  do
    ...
    load("Source.SlipeServer.Accounts.AccountManager")
    ...
    load("Source.SlipeServer.Elements.ElementHelper")
    ...
    load("Source.SlipeServer.GameServer.BandwidthReduction")
    load("Source.SlipeServer.GameServer.Config")
    load("Source.SlipeServer.GameServer.Glitch")
    load("Source.SlipeServer.GameServer.Server")
    load("Source.SlipeServer.GameServer.Team")
    ...
    load("Source.SlipeServer.Peds.PlayerManager")
    ...
    load("Source.SlipeServer.Resources.ResourceManager")
    ...
    load("Source.SlipeShared.Elements.IElementHelper")
  ...
  System.init({
    ...
    "Slipe.Shared.Elements.IElementHelper",
    ...
    "Slipe.Server.Accounts.AccountManager",
    ...
    "Slipe.Server.Elements.ElementHelper",
    ...
    "Slipe.Server.GameServer.BandwidthReduction",
    "Slipe.Server.GameServer.Config",
    "Slipe.Server.GameServer.Glitch",
    "Slipe.Server.GameServer.Server",
    "Slipe.Server.GameServer.Team",
    ...
    "Slipe.Server.Peds.PlayerManager",
    ...
    "Slipe.Server.Resources.ResourceManager",
